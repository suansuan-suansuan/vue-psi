		...
		<el-form :model="form" ref="form" label-width="100px">
			...
			<div>
				...
				<el-form-item label="选择仓库" :label-width="formLabelWidth">
					<el-select value-key="depotId" v-model="form.BaseDepot" placeholder="请选择">
				...
				<el-form-item label="选择供应商" :label-width="formLabelWidth">
					<el-select value-key="vendorId" v-model="basevendor" placeholder="请选择" @change="findbasevendor()">
		...
		<el-form :model="form" ref="form" label-width="100px">
			<div>
				...
				<el-form-item label="选择产品" :label-width="formLabelWidth">
					<el-select value-key="productId" v-model="form.BaseProduct" placeholder="请选择">
						<el-option v-for="item in BaseProductData" :key="item.productId" :label="item.productName"
